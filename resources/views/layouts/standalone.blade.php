...
<head>
    ...
    {{-- Small theme boot (uses your existing localStorage key tw-theme) --}}
    <script>
      (function () {
        try {
    ...
    {{-- Minimal token fallback (so standalone looks premium even without app.css) --}}
    <style>
      :root{
...
<body class="min-h-screen text-[color:var(--tw-fg)] bg-(--tw-bg)">
    {{-- Background treatment (subtle, premium) --}}
    ...
    <main class="w-full">
        <div class="mx-auto w-full max-w-[980px] px-4 sm:px-6 pt-8 sm:pt-10 pb-12">
            ...
            {{-- Optional header bar (theme-aware) --}}
