...
<header class="sticky top-0 z-50 border-b border-slate-800/70 bg-slate-950">
    <div class="px-4 md:px-6 py-3 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            {{-- Company pill (the ONLY place for company switching trigger) --}}
            <button type="button"
...
{{-- one overlay for closing popovers --}}
<div id="twTopbarOverlay" class="hidden fixed inset-0 z-[60]"></div>

{{-- popovers: SOLID (no transparency, no blur), fixed-positioned by JS --}}
<div id="pop-company"
...
<div id="pop-quick"
    ...
    <div class="p-2 grid gap-1">
        <a href="{{ route('settings.depots.index') }}" class="px-3 py-2 rounded-xl hover:bg-slate-900 transition text-[13px]">Depot</a>
        <a href="{{ route('settings.suppliers.index') }}" class="px-3 py-2 rounded-xl hover:bg-slate-900 transition text-[13px]">Supplier</a>
        <a href="{{ route('settings.transporters.index') }}" class="px-3 py-2 rounded-xl hover:bg-slate-900 transition text-[13px]">Transporter</a>
    </div>
</div>
...
<div id="pop-search"
    ...
    <div id="twTopbarSearchList" class="p-2 grid gap-1">
        <a data-key="dashboard summary" href="{{ route('dashboard') }}" class="tw-s-item px-3 py-2 rounded-xl hover:bg-slate-900 transition">
            <div class="text-[13px] font-semibold">Dashboard</div>
            <div class="text-[11px] text-slate-400">Summary</div>
        </a>
        <a data-key="depot stock ago" href="{{ route('depot-stock.index') }}" class="tw-s-item px-3 py-2 rounded-xl hover:bg-slate-900 transition">
            <div class="text-[13px] font-semibold">Depot Stock</div>
            <div class="text-[11px] text-slate-400">Live AGO</div>
        </a>
        <a data-key="depots settings" href="{{ route('settings.depots.index') }}" class="tw-s-item px-3 py-2 rounded-xl hover:bg-slate-900 transition">
