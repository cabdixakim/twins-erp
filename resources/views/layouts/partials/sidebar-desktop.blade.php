...
<aside id="desktopSidebar"
        ...
        <div class="flex items-center gap-3 min-w-0">
            ...
            <div class="min-w-0 sidebar-label">
                <div class="font-semibold text-[12px] uppercase tracking-[0.12em] truncate"
                    ...
                    {{ $company->name ?? config('app.name', 'Twins ERP') }}
                </div>
    ...
    <div class="flex-1 overflow-hidden">
        <div class="h-full overflow-y-auto px-3 py-4 space-y-4 text-sm">
            @include('layouts.partials.nav-primary', compact('onDashboard','onDepotStock','onPurchases','onSales','onClients','onInvoices','onTransporters','onSuppliers','onDepotLedger','onPettyCash','onBanks','onReports'))
