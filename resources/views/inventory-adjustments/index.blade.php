...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
  <div class="relative overflow-hidden rounded-2xl border {{ $border }} {{ $surface }} p-4">
    <div class="absolute inset-0 opacity-[0.03]" style="background:linear-gradient(135deg,#f43f5e,transparent 60%)"></div>
  ...
  <div class="relative overflow-hidden rounded-2xl border {{ $border }} {{ $surface }} p-4">
    <div class="absolute inset-0 opacity-[0.03]" style="background:linear-gradient(135deg,#10b981,transparent 60%)"></div>
    <div class="relative flex items-start justify-between">
      <div>
