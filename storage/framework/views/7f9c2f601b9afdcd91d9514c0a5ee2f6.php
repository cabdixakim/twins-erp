...
<?php $__env->startSection('title','New AGO Purchase'); ?>
...
<div class="w-full max-w-180 mx-auto">
    ...
    <form method="post" action="<?php echo e(route('purchases.store')); ?>" class="rounded-2xl bg-slate-950 ring-1 ring-slate-800 p-4 space-y-4">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.standalone', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\twins-erp\resources\views/purchases/create.blade.php ENDPATH**/ ?>