...
<header class="sticky top-0 z-50">
    ...
    <div class="tw-surface border-b border-[color:var(--tw-border)] px-4 md:px-6 py-2.5 md:py-3 flex items-center justify-between gap-3 md:gap-4">
        ...
        <div class="flex items-center gap-1.5 md:gap-2">
            ...
            <button type="button" data-popover-btn="quick" class="<?php echo e($iconBtn); ?>" aria-label="Quick create">
                <svg class="w-4 h-4 md:w-[17px] md:h-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 5v14M5 12h14"/>
                </svg>
            </button>

            <button type="button" data-popover-btn="search" class="<?php echo e($iconBtn); ?>" aria-label="Search">
                <svg class="w-4 h-4 md:w-[17px] md:h-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <button type="button" data-popover-btn="notif" class="<?php echo e($iconBtn); ?>" aria-label="Notifications">
                <svg class="w-4 h-4 md:w-[17px] md:h-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <button type="button" data-popover-btn="profile" class="<?php echo e($iconBtn); ?>" aria-label="Profile">
                <svg class="w-4 h-4 md:w-[17px] md:h-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<div id="pop-company" class="<?php echo e($popover); ?>">
    <div class="px-4 py-3 border-b border-[color:var(--tw-border)]">
        ...
        <div class="text-[13px] font-semibold truncate text-[color:var(--tw-fg)]">
            ...
            <?php if($activeCompanyCode): ?>
                <span class="ml-2 text-xs text-[color:var(--tw-muted)]">[<?php echo e($activeCompanyCode); ?>]</span>
            <?php endif; ?>
        </div>
    </div>
    <div class="p-2">
        <a href="<?php echo e(route('companies.switcher')); ?>" class="flex items-center gap-3 <?php echo e($popItem); ?>">
...
<div id="pop-quick" class="<?php echo e(str_replace('w-[22rem]', 'w-[18rem]', $popover)); ?>">
    <div class="px-4 py-3 border-b border-[color:var(--tw-border)]">
        <div class="text-[13px] font-semibold">Quick create</div>
        <div class="text-[11px] tw-muted">Common setup</div>
    </div>
    <div class="p-2 grid gap-1">
        <a href="<?php echo e(route('settings.depots.index')); ?>" class="<?php echo e($popItem); ?> text-[13px]">Depot</a>
        <a href="<?php echo e(route('settings.suppliers.index')); ?>" class="<?php echo e($popItem); ?> text-[13px]">Supplier</a>
        <a href="<?php echo e(route('settings.transporters.index')); ?>" class="<?php echo e($popItem); ?> text-[13px]">Transporter</a>
    </div>
</div>


<div id="pop-search" class="<?php echo e(str_replace('w-[22rem]', 'w-[24rem]', $popover)); ?>">
    ...
    <div id="twTopbarSearchList" class="p-2 grid gap-1">
        <a data-key="dashboard summary" href="<?php echo e(route('dashboard')); ?>" class="tw-s-item <?php echo e($popItem); ?>">
            <div class="text-[13px] font-semibold">Dashboard</div>
            <div class="text-[11px] tw-muted">Summary</div>
        </a>
        <a data-key="depot stock ago" href="<?php echo e(route('depot-stock.index')); ?>" class="tw-s-item <?php echo e($popItem); ?>">
            <div class="text-[13px] font-semibold">Depot Stock</div>
            <div class="text-[11px] tw-muted">Live AGO</div>
        </a>
        <a data-key="depots settings" href="<?php echo e(route('settings.depots.index')); ?>" class="tw-s-item <?php echo e($popItem); ?>">
...
<div id="pop-notif" class="<?php echo e($popover); ?>">
...
<div id="pop-profile" class="<?php echo e($popover); ?>">
    <div class="px-4 py-3 border-b border-[color:var(--tw-border)]">
        <div class="text-[11px] tw-muted">Signed in</div>
        <div class="text-[13px] font-semibold truncate"><?php echo e($u?->name ?? 'User'); ?></div>
        <div class="text-[11px] tw-muted truncate"><?php echo e($u?->email ?? ''); ?></div>
    </div>
    <div class="p-2">
        <a href="<?php echo e(route('settings.company.edit')); ?>" class="flex items-center gap-3 <?php echo e($popItem); ?>">
            <span class="h-9 w-9 rounded-xl grid place-items-center bg-[color:var(--tw-surface-2)] border border-[color:var(--tw-border)]">
                <svg class="w-[17px] h-[17px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <form method="post" action="<?php echo e(route('logout')); ?>">
            <?php echo csrf_field(); ?>
            <button type="submit" class="cursor-pointer select-none w-full flex items-center gap-3 <?php echo e($popItem); ?> text-left">
...
</script><?php /**PATH /home/runner/workspace/resources/views/layouts/partials/topbar.blade.php ENDPATH**/ ?>