<header class="sticky top-0 z-40 flex items-center justify-between px-4 md:px-6 py-3
    ...
    <div class="min-w-0 flex items-center gap-3">
        ...
        <div class="min-w-0">
            <div class="text-sm md:text-base font-semibold truncate"><?php echo $__env->yieldContent('title','Dashboard'); ?></div>
            <div class="hidden md:block text-xs text-slate-400 truncate"><?php echo $__env->yieldContent('subtitle'); ?></div>
        </div>
    </div>
...
</header><?php /**PATH C:\xampp\htdocs\twins-erp\resources\views/layouts/partials/topbar.blade.php ENDPATH**/ ?>