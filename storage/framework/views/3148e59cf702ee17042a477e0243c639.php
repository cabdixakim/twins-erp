...
<head>
  ...
  <title>Setup <?php echo e(config('app.name', 'Twins')); ?></title>
      ...
      <div class="hidden md:flex md:col-span-2 flex-col justify-between bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950/90 px-6 py-6 border-r border-slate-800">
        <div>
          <div class="inline-flex items-center gap-2 mb-6">
            ...
            <div>
              <div class="text-sm font-semibold text-slate-50 tracking-wide"><?php echo e(config('app.name', 'Twins')); ?></div>
              <div class="text-[11px] text-slate-400">Fuel &amp; Transport ERP</div>
            </div>
          </div>

          <h1 class="text-xl font-semibold text-slate-50 mb-2">
            Welcome to <?php echo e(config('app.name', 'Twins')); ?>
          ...
          <div class="space-y-3 text-xs text-slate-300">
            ...
            <div class="flex items-center gap-2 opacity-60">
              ...
              <span>Configure depots, clients &amp; transport (inside <?php echo e(config('app.name', 'Twins')); ?>)</span>
            </div>
          </div>
        </div>
      ...
      <div class="md:col-span-3 px-5 py-6 md:px-7 md:py-7">
        <form method="post" action="<?php echo e(route('company.store')); ?>" class="space-y-5">
          ...
          <div class="md:hidden mb-2">
            <h1 class="text-lg font-semibold text-slate-50">Welcome to <?php echo e(config('app.name', 'Twins')); ?></h1>
...
unset($__errorArgs, $__bag); ?>"
                placeholder="Short unique code, e.g. <?php echo e(strtoupper(config('app.name', 'Twins'))); ?>"
                required
              >
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="pt-2 space-y-2">
            ...
            >
              Start <?php echo e(config('app.name', 'Twins')); ?>

            </button>
            <p class="text-[11px] text-slate-500 text-center">
              By continuing you confirm you’re setting up <?php echo e(config('app.name', 'Twins')); ?> for your own company.
            </p>
          </div>
        </form>
      </div>
...
</html><?php /**PATH /home/runner/workspace/resources/views/onboarding/company_create.blade.php ENDPATH**/ ?>